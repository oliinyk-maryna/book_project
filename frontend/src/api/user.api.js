...
export const userApi = {
  ...
  getProfileConnections:(type)       => client(`/me/connections?type=${type}`),
  ...
  addSession:     (id, data) => client(`/me/books/${id}/sessions`, { method: 'POST', body: data }),
  ...
  // DM (зберігаємо для сумісності, але UI переорієнтовано на клуби)
